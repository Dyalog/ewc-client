...
// NuGrid Border property — left grid uses Border 1, right grid uses Border 0.
...
test.describe('DemoNuGridBorders - Border property', () => {
  let browser: Browser;
  let page: Page;
  ...
  test.beforeAll(async () => {
    ...
    page = await navigateToDemo(result.page, 'NuGridBorders', '.nugrid-table', 10000);
  });
  ...
  test('both NuGrids render', async () => {
