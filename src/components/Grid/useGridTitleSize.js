...
// Hook that resolves Grid TitleWidth / TitleHeight / CellWidths per
// ⎕WC semantics:
...
// 15px + 1px collapsed gridline, matching .grid-cell data rows.
...
export default useGridTitleSize;
